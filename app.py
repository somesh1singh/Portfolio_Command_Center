...
with st.sidebar:
    ...
    with st.expander("Advanced completeness inputs"):
        ...
        mf_upload = st.file_uploader("E. Mutual-fund transactions", type=["csv", "xlsx", "xls"], key="mf_transactions", help="CAS/Coin transactions for scheme-level FIFO and XIRR.")
        income_upload = st.file_uploader("F. Zerodha dividend / investment-income statement", type=["csv", "xlsx", "xls"], key="investment_income", help="Upload the dividend statement downloaded from Zerodha Console, or bank-paid investment-income rows. These amounts are included in income totals and account XIRR.")
        ...
        action_upload = st.file_uploader("H. Corporate-action register", type=["csv", "xlsx", "xls"], key="corporate_action_file", help="Optional verified split, bonus, merger and demerger register.")
...
if mf_upload:
    ...
    try:
        mf_source = read_upload(mf_upload)
...
if action_upload:
    try:
        candidate_actions = read_upload(action_upload)
...
if income_upload:
    ...
    try:
        income_source = read_upload(income_upload)
